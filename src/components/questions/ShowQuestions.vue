<template>
  ...
  <transition-group name="fade" mode="out-in">
    <div class="ctr">
      ...
      <result v-else :loggedInUser="loggedInUser" :results="results" :totalCorrect="totalCorrect" :questions="questions">
      </result>
    ...
    async fetchQuestions() {
      try {
        const response = await axios.get(
          "http://134u123.e2.mars-hosting.com/project_quiz/quiz/questions"
        );
